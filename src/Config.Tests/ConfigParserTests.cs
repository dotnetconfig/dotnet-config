...
namespace DotNetConfig.Tests
{
    public class ConfigParserTests
    {
        ...
        [InlineData("connection=\"DefaultEndpointsProtocol=https;AccountName=;AccountKey=;BlobEndpoint=\"", "connection", "DefaultEndpointsProtocol=https;AccountName=;AccountKey=;BlobEndpoint=")]
